...
- **Content**: Markdown-basierte Artikel mit YAML Front Matter
- **Styling**: SCSS mit Bootstrap-Basis
- **Struktur**: Git Submodule für gemeinsame Ressourcen (`shared/`)
...
- `author`: Vollständiger Name des Autors (muss in `_data/users/` existieren)
...
_posts/
  YYYY-MM-DD-artikel-slug/
    YYYY-MM-DD-artikel-slug.md    # Hauptartikel
    header.jpg                     # Header-Bild (automatisch generiert)
...
### Asset-Pfade
- **Bilder im Artikel**: Relativer Pfad zu Artikel-Ordner
- **Lazy Loading**: `class="lazy"` für Performance
- **Placeholder**: `/shared/assets/img/placeholder-image.svg`
