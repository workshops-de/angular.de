...
author: "Lulëzim Ukaj"
published_at: 2024-01-19T16:00:28.000Z
...
<p class="text-center">
<img style="max-width:60%" src="angular-logo.jpg" alt="Das neue Angular Logo" class="img-fluid img-rounded" loading="lazy">
</p>
...
<p class="text-center">
<img style="max-width:100%" src="angulardev-screenshot.jpg" alt="Die neue Angular.DEV Platform im Welcome Screen" class="img-fluid img-rounded" loading="lazy">
</p>
...
<p class="text-center">
<img style="max-width:60%" src="esbuild.jpg" alt="Logos Vite und Esbuild" class="img-fluid img-rounded" loading="lazy">
</p>
...
<p class="text-center">
<img style="max-width:60%" src="hydration.jpg" alt="Logo Angular Hydration" class="img-fluid img-rounded" loading="lazy">
</p>
