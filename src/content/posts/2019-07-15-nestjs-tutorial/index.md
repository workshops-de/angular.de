...
author: "Robin Böhm"
published_at: 2019-06-21T10:15:01.000Z
...
<img src="client-server-api.png" alt="Client Server API Illustration" class="center" loading="lazy">
...
<div class="workshop-hint">
  ...
  <div class="row mb-2">
    ...
    <div class="col-xs-12 col-md-6">
      <img class="img-fluid img-rounded" style="margin-top:-20px" src="/shared/assets/img/placeholder-image.svg" alt="Teilnehmer:innen in unser Intensiv Schulung" loading="lazy">
    </div>
  </div>
</div>
<hr>
...
<img src="nestjs-api-controller.png" alt="Client request to an API and controller routing" class="center" loading="lazy">
...
<img src="nestjs-eventcontroller.png" alt="Client request to an API and controller routing" class="center" loading="lazy">
...
<img src="nestjs-controller-di.png" alt="Client request to an API and controller routing" class="center-80" loading="lazy">
...
<img src="nestjs-module.png" alt="Client request to an API and controller routing" class="center-80" loading="lazy">
...
<div class="workshop-hint">
  ...
  <div class="row mb-2">
    ...
    <div class="col-xs-12 col-md-6">
      <img class="img-fluid img-rounded" src="/shared/assets/img/placeholder-image.svg" alt="Teilnehmer:innen in unser Intensiv Schulung" loading="lazy">
    </div>
  </div>
</div>
<hr>
