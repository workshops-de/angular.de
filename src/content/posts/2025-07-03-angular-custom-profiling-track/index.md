...
<p class="left">
<img style="max-width: 80%" src="chrome_custom_track.webp" alt="chrome custom track" class="img-fluid img-rounded" loading="lazy">
</p>
...
<p class="left">
<img style="max-width: 80%" src="profile-change-detection.png" alt="chrome custom track" class="img-fluid img-rounded" loading="lazy">
</p>
...
<p class="left">
<img style="max-width: 80%" src="profile-angular-vs-3rd-party.png" alt="chrome custom track" class="img-fluid img-rounded" loading="lazy">
</p>
