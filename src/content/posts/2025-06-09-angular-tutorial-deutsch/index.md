...
<p class="text-center">
<img style="max-width:40%" src="preview-bookmonkey-app.png" alt="Beispielansicht unserer Anwendung die in diesem Tutorial gemeinsam gebaut wird. Eine Liste an Büchern welche von einem Server geladen wird." class="img-fluid img-rounded" loading="lazy">
</p>
...
<img src="angular-history.png" alt="Angular Historie - Ein Zeitstrahl, welcher sich 2016 in zwei Zweige aufgeteilt hat. AngularJS und Angular." class="img-fluid img-rounded" loading="lazy">
...
<img class="img-fluid img-rounded" src="release-cycle.png" alt="Der Angular Release Cycle. Major Release alle 6 Monate. 1-3 Monate Minor Releases. Patch Release jede Woche." loading="lazy">
...
<img class="img-fluid img-rounded" src="angular-platform-overview.png" alt="Angular Platform Overview. Viele verschiedene Blöcke mit Modulen wie Forms, OWA, HTTP, I81n, Language Services, Router, Animcations Cli, Components und dem Core Framework selber." loading="lazy">
...
<img class="img-fluid img-rounded" src="first-ng-serve.png" alt="Die Webansicht von ng serve nach dem generieren der Angular Anwedung." loading="lazy">
...
<img class="img-fluid img-rounded" src="basic-todo-component-annotated.png" alt="Beispiel ToDo App, welche die Anwendung in verschiedene logische Bausteine unterteilt wie Title, ItemList und Items." loading="lazy">
...
<img class="img-fluid img-rounded" src="angular-component-service-simple-example.png" alt="Beispiel der Beziehung von Angular Komponenten und Services." loading="lazy">
...
<img class="img-fluid img-rounded" src="info-box-with-expression.png" alt="Beispiel einer Item-Komponenten-Definition der eben gezeigten ToDo App" loading="lazy">
...
<img class="img-fluid img-rounded" src="info-box-with-expression.png" alt="Ausgabe der Info-Box Komponente mit unserem dynamischen Expression Text" loading="lazy">
...
<img class="img-fluid img-rounded" src="info-box-toggle.gif" alt="Animation der Basis Show and Hide Infobox" loading="lazy">
...
<img class="img-fluid img-rounded" src="static-list-of-books.png" alt="Die liste der statischen Bücher in HTML ausgeben" loading="lazy">
...
<img class="img-fluid img-rounded" src="extract-service.gif" alt="Animation der Extraktion der Daten von der Komponente in einen Service." loading="lazy">
...
<img class="img-fluid img-rounded" src="di-explained-dialog.gif" alt="Angular DI erklärt indem die Komponente mit dem Injektor einen Dialog über ihre Bedürfnisse führt" loading="lazy">
...
<img class="img-fluid img-rounded" src="http-list-of-books.png" alt="Die Ausgabe der Liste von Büchern aus dem HTTP-Backend" loading="lazy">
