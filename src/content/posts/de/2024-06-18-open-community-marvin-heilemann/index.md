...
<p class="left">
    <img style="max-width: 80%" src="szenario1typea.jpg" alt="Screenshot aus den Angular DevTools Profiler, zeigt die Initial Loading Time - 15ms" class="img-fluid img-rounded" loading="lazy">
    <br>
    <em>ComponentRef</em>
</p>
...
<p class="left">
    <img style="max-width: 80%" src="szenario1typeb.jpg" alt="Screenshot aus den Angular DevTools Profiler, zeigt die Initial Loading Time - 14ms" class="img-fluid img-rounded" loading="lazy">
    <br>
    <em>Switch</em>
</p>
...
<p class="left">
    <img style="max-width: 80%" src="szenario2typea.jpg" alt="Screenshot aus den Angular DevTools Profiler, zeigt die Initial Loading Time - 17ms" class="img-fluid img-rounded" loading="lazy">
    <br>
    <em>ComponentRef</em>
</p>
...
<p class="left">
    <img style="max-width: 80%" src="szenario2typeb.jpg" alt="Screenshot aus den Angular DevTools Profiler, zeigt die Initial Loading Time - 12ms" class="img-fluid img-rounded" loading="lazy">
    <br>
    <em>Switch</em>
</p>
...
<p class="left">
    <img style="max-width: 80%" src="szenario3typea.jpg" alt="Screenshot aus den Angular DevTools Profiler, zeigt die Initial Loading Time - 4ms" class="img-fluid img-rounded" loading="lazy">
    <br>
    <em>ComponentRef</em>
</p>
...
<p class="left">
    <img style="max-width: 80%" src="szenario3typeb.jpg" alt="Screenshot aus den Angular DevTools Profiler, zeigt die Initial Loading Time - 3ms" class="img-fluid img-rounded" loading="lazy">
    <br>
    <em>Switch</em>
</p>
