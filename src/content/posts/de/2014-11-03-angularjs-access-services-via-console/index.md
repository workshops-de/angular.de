...
**_Hinweis zur Version:_** _Alle Beispiele wurden mit Angular 1.2.22 getestet, aber da ich auch viel mit 1.0.8 arbeite, sollten sie auch damit funktionieren._
...
Man kann diese Überprüfung über Aktionen manuell auslösen, die von Angular registriert werden, wie z.B das Wechseln zwischen den Todo Filtern _Active_ und _Inactive_.
...
Das Problem ist leicht zu beheben, wenn man das Modul für den `$http`-Service hinzufügt (_Tipp_: `ng`) und es zu dem Array von abhängigen Modulen hinzufügt.
