...
- $ionicPopup._show_(options)
  ...
  - options:
    ...
    - buttons (Array.Object)
      ...
      - Schlüssel sind _text_ (String - Buttonbeschriftung), _type_ (String - Button-CSS-Klasse), _onTap_ (Function - Callback-Funktion, wenn Button angeklickt wurde, erhält als Parameter das Event)
...
Als Rückgabewert liefern alle Funktionen ein Promise. Dieses Promise hat eine zusätzliche Funktion _close()_, um das Popup programmatisch zu schließen. Generell wird das Promise resolved, wenn das Popup geschlossen wird. Durch die verschiedenen Typen erhält die Resolve-Funktion auch verschiedene Werte.

- _alert()_, _show()_ - keinen besonderen Wert
- _confirm()_ - **true**, falls OK-Button, **false** wenn Cancel-Button gedrückt
- _prompt()_ - **Eingabewert**, falls OK-Button, und **undefined** falls Abbrechen-Button gedrückt
...
[[cta:training-bottom]]
        ...
        "Füge zuerst Produkte aus Unserem Angebot zu Deinem Warenkorb hinzu.",
    });
  }
});
```
