...
Dabei kann diese über ein Objekt (_options_) konfiguriert und der erstellte Slider mit einer Scope-Variable (_slider_) verknüpft werden. Das Options-Objekt kann dabei alle verfügbaren Einstellungen des Sliders entgegen. Unter anderem können Standardwerte, wie Höhe und Breite gesetzt werden oder ob die Slides automatisch durchlaufen und wenn wie schnell.
...
Die Variable _entfernMich_ hält dann eine Funktion, um den Watcher wieder zu entfernen.
