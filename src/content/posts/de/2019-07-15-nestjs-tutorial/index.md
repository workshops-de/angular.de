...
![Client Server API Illustration](client-server-api.png)
...
![Client request to an API and controller routing](nestjs-api-controller.png)
...
![Client request to an API and controller routing](nestjs-eventcontroller.png)
...
![Client request to an API and controller routing](nestjs-controller-di.png)
...
![Client request to an API and controller routing](nestjs-module.png)
