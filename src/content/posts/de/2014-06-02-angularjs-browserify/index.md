...
description: "Browserify ist eine Alternative zu gängigen Projekt-Setups. Der Mehrwert ist die Modularisierung des Codes und das einfache Einbinden von npm-Paketen."
author: "Bastian Krol"
...
Der erste Schönheitsfehler, den wir beseitigen, ist die lange Liste von `require`-Statements in `app.js`. In `app.js` geben wir nur noch die die _Verzeichnisse_ an, aus denen wir Module importieren wollen.
