...
![Cypress Fehlermeldung auf dem Build-Server, die genau sagt, wie der Fehler zu beheben sei](02-ci-error.png)
...
![Cypress Oberfläche nach cypress:open oder e2e](03-cy-open.png)
...
![Fehlschlagender Test, der aktuell noch nicht implementiert ist](04-cy-test.png)
...
![Unsere erste Cypress Testreihe erfolgreich laufen lassen](05-cy-workflow.gif)
...
![CircleCI Dashboard](06-circleci.png)
...
![Animiertes Bild, das eine überwältigte Person zeigt](08-mind-blown.gif)
