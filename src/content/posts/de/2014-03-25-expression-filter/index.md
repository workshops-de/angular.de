...
_Collectionfilter_ kommen in Verbindung mit der `ngRepeat`-Direktive zum Einsatz, während _Expressionfilter_ - wie der Name es bereits vermuten lässt - in Expressions verwendet werden können.
