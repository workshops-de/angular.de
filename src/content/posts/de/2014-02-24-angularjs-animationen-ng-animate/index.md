...
- _enter_: ein neues Element wird in die Liste eingefügt
- _leave_: ein Element wird aus der Liste entfernt
- _move_: ein bestehendes Element wird innerhalb der Liste verschoben
...
Die Namen der zusätzlichen CSS-Klassen kommen über _Konvention_ zustande:

- _enter_: `.ng-enter` und `.ng-enter-active`
- _leave_: `.ng-leave` und `.ng-leave-active`
- _move_: `.ng-move` und `.ng-move-active`
