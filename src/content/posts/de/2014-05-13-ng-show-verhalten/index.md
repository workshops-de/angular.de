...
Andreas Becker war so lieb und hat im [AngularJS Tutorial](/artikel/angularjs-tutorial-deutsch/) auf das merkwürdige Verhalten von _ng-show_ hingewiesen:
...
Das bedeutet, wenn in einem String **f, 0, false, no, n oder []** steht, wird dieser als _false_ gewertet.
