...
![Infografik Auflistung derWeb Core Vitals: Contentful Paint (LCP), dem First Input Delay (FID) und dem Cumulative Layout Shift (CLS)](vitals.jpg)
...
![Infografik Darstellung des Largest Contentful Paint am Beispiel der Webansicht für Instagram](largestcontentfulpaint.jpg)
...
![Infografik CLS: Button verschiebt sich nach unten durch verzögerte Einblendung von Inhalten in Webansicht](cumulativeshift.jpg)
