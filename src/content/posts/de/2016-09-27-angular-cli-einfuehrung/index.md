...
**public**: Hier werden eigene Libs oder 3rd Party libs abgelegt die dann von cli mit kopiert werden und global verfügbar sind.

**src**: Das ist unser entwicklungs Ordner. Hier spielt die Musik.

**e2e**: Dieser Ordner wird für die end-to-end Tests genutzt.

**config**: Hier liegen u.a. die Konfigurationsdateien für die Tests.
...
describe("App: HelloCli", () => {
  ...
  it("should have as title 'Hi from my-service.service.ts'", inject(
    [AppComponent],
    (app: AppComponent) => {
...
Jetzt sollte der Test _grün_ sein.
...
Danach sollt auch der e2e Test _grün_ sein.
