...
<p class="left">
<img style="max-width: 80%" src="2.jpg" alt="Infografik, die den Data Flow von einer Parentkomponente zur Childkomponente darstellt" class="img-fluid img-rounded" loading="lazy">
</p>
...
<p class="left">
<img style="max-width: 80%" src="1.jpg" alt="Grafische Darstellung einer Grußkarten Web-Anwendung bestehend aus zwei select-Elementen und einer Textbox" class="img-fluid img-rounded" loading="lazy">
</p>
